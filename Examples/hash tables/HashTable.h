	...
	public:
		...
		int getValue(int key)
		{
			...
			else
			{
				...
				//if there were collisions, iterate through the list at the index until you find the right key
		...
		void putValue(int key, int value)
		{
			...
			if(hashArray[bucketIndex] == NULL) //no collision, nothing at bucketIndex
			{
